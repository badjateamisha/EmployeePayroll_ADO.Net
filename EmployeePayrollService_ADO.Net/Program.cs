...
while (true)
{
    ...
    switch (option)
    {
        ...
        case 4:
            ...
            employeeDetails.FirstName = "Mehr";
            employeeDetails.LastName = "Kalburgi";
        ...
        case 6:
            ...
            employeeDetails2.Add(new Employee_details2(EmployeeID: 2, FirstName: "Amisha", LastName: "Jain", Gender: "Female", StartDate: DateTime.Now, Company: "bridge Labs", Departent: "Development", Address: "Pune", BasicPay: 20000, Deductions: 1000, TaxablePay: 200, IncomeTax: 180, NetPay: 25000));
            employeeDetails2.Add(new Employee_details2(EmployeeID: 1, FirstName: "Disha", LastName: "Jain", Gender: "Female", StartDate: DateTime.Now, Company: "bridge Labs", Departent: "Development", Address: "Abad", BasicPay: 20000, Deductions: 1000, TaxablePay: 200, IncomeTax: 180, NetPay: 25000));
            employeeDetails2.Add(new Employee_details2(EmployeeID: 3, FirstName: "Roshni", LastName: "John", Gender: "Female", StartDate: DateTime.Now, Company: "bridge Labs", Departent: "Development", Address: "Abad", BasicPay: 20000, Deductions: 1000, TaxablePay: 200, IncomeTax: 180, NetPay: 25000));
            employeeDetails2.Add(new Employee_details2(EmployeeID: 4, FirstName: "Sagar", LastName: "Kalburgi", Gender: "Male", StartDate: DateTime.Now, Company: "bridge Labs", Departent: "Development", Address: "Pune", BasicPay: 20000, Deductions: 1000, TaxablePay: 200, IncomeTax: 180, NetPay: 25000));
            employeeDetails2.Add(new Employee_details2(EmployeeID: 5, FirstName: "Aarvik", LastName: "Kalburgi", Gender: "Male", StartDate: DateTime.Now, Company: "bridge Labs", Departent: "Development", Address: "Pune", BasicPay: 20000, Deductions: 1000, TaxablePay: 200, IncomeTax: 180, NetPay: 25000));
